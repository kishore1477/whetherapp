...
const Header = () => {
  return (
    ...
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 mr-4">
      ...
      |
      <span className='font-bold text-blue-500 ml-10' >
        <a href='https://github.com/kishore1477/whetherapp' target="_blank">
        Source code
        </a>
      </span>
