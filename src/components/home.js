...
setFormdata({city:''})
  ...
  <button onClick={handleformSubmit} className="text-white bg-blue-500 border-0 py-2 px-4 md:px-8 focus:outline-none hover:bg-blue-600 rounded md:text-lg">
    Search
  </button>
  
</div>
</form>
{cond? <HandlewhetherData  whetherData = {whetherData}/>:<h1 className='ml-8'>Enter a city name to get the whether  information of that city</h1>
   }
